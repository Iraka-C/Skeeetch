...
LANG_EN={
	...
	"delete-file":"Delete ",
	"delete-file-confirm":(name)=>`Delete ${name} from repository?`,
	"delete-cloud-file-confirm":(name)=>`Delete ${name} from repository and cloud?`,
	...
	"file-cloud-deleted":"Deleted from repository and cloud.",
	"file-deleting":(name)=>`Removing ${name} from repository ...`,
